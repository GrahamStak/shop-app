			...
			<div className="row">
				...
				<div className="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_1.jpg" className="fh5co-card-item image-popup">
						<figure>
							...
							<img src="images/img_1.jpg" alt="Image" className="img-responsive"></img>
						</figure>
				...
				<div className="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_2.jpg" className="fh5co-card-item image-popup">
						<figure>
							<div className="overlay"><i className="ti-plus"></i></div>
							<img src="images/img_2.jpg" alt="Image" className="img-responsive"></img>
						</figure>
						<div className="fh5co-text">
				...
				<div className="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_3.jpg" className="fh5co-card-item image-popup">
						<figure>
							<div className="overlay"><i className="ti-plus"></i></div>
							<img src="images/img_3.jpg" alt="Image" className="img-responsive"></img>
						</figure>
						<div className="fh5co-text">
				...
				<div className="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_4.jpg" className="fh5co-card-item image-popup">
						<figure>
							<div className="overlay"><i className="ti-plus"></i></div>
							<img src="images/img_4.jpg" alt="Image" className="img-responsive"></img>
						</figure>
						<div className="fh5co-text">
							<h2>Organic Egg</h2>
							<p>Far far away, behind the word mountains, far from the countries Vokalia..</p>
				...
				<div className="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_5.jpg" className="fh5co-card-item image-popup">
						<figure>
							<div className="overlay"><i className="ti-plus"></i></div>
							<img src="images/img_5.jpg" alt="Image" className="img-responsive"></img>
						</figure>
						<div className="fh5co-text">
				...
				<div className="col-lg-4 col-md-4 col-sm-6">
					<a href="images/img_6.jpg" className="fh5co-card-item image-popup">
						<figure>
							<div className="overlay"><i className="ti-plus"></i></div>
							<img src="images/img_6.jpg" alt="Image" className="img-responsive"></img>
						</figure>
						<div className="fh5co-text">
